...
export async function POST(req: NextRequest) {
  ...
  const row = await sql`
    INSERT INTO website_alumni (name,role,department,email,linkedin_url,image_url,image_position,image_zoom,now_at_type,now_at_company,now_at_role,now_at_url,is_active)
    VALUES (${a.name},${a.role||''},${a.department||''},${a.email||null},${a.linkedin_url||null},${a.image_url||null},${a.image_position||'50% 0%'},${a.image_zoom||1},${a.now_at_type||'working'},${a.now_at_company||null},${a.now_at_role||null},${a.now_at_url||null},${a.is_active!==false})
    RETURNING id`
  revalidatePath('/team')
...
export async function PUT(req: NextRequest) {
  ...
  await sql`
    UPDATE website_alumni SET
      ...
      image_position=${a.image_position||'50% 0%'},image_zoom=${a.image_zoom||1},
