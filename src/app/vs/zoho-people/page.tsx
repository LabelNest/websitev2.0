...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata('/vs/zoho-people', {
    ...
    description: 'How NestHR compares to Zoho People on pricing, modules, and campus placement — flat annual pricing by team size with PlacementOS included vs Zoho People\'s per-employee-per-month tiers plus payroll add-on.',
  })
}
...
const DATA: VsPageData = {
  ...
  tableRows: [
    { feature: 'Pricing model', competitor: { text: '₹50-₹230/employee/month across 4 tiers (₹600-₹2,760/year), plus GST', verdict: 'mid' }, labelnest: { text: '₹40,000-₹1,00,000/year flat, all modules included', verdict: 'win' } },
    ...
    { feature: 'Free tier', competitor: { text: 'Free for up to 5 employees', verdict: 'win' }, labelnest: { text: 'No free tier stated — Starter begins at ₹40,000/year flat', verdict: 'no' } },
