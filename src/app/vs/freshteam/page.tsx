...
const DATA: VsPageData = {
  ...
  tldrRightPoints: [
    ...
    'You want all 7 modules included at a flat annual price based on team size',
  ...
  tableRows: [
    ...
    { feature: 'Pricing model', competitor: { text: 'Free up to 50 employees; $1.20-$4.80/employee/month paid tiers', verdict: 'win' }, labelnest: { text: '₹40,000-₹1,00,000/year flat, all modules included', verdict: 'win' } },
