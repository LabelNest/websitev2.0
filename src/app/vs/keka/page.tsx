...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata('/vs/keka', {
    ...
    description: 'How NestHR compares to Keka on pricing, modules, and campus placement — flat annual INR pricing by team size with all 7 modules included vs Keka\'s tiered flat-fee-plus-per-employee model.',
  })
}
...
const DATA: VsPageData = {
  ...
  subhead: 'Keka is a well-established Indian HRMS — tiered flat-fee-plus-per-employee pricing, starting at ₹9,999/month for up to 100 employees. NestHR is simple flat annual pricing by team size with all 7 modules included and no tier upsells, plus PlacementOS, a campus and startup hiring module Keka doesn\'t offer.',
  ...
  tldrRightPoints: [
    'You want simple flat annual pricing based on team size, not a tiered flat-fee-plus-overage model',
  ...
  tableRows: [
    { feature: 'Pricing model', competitor: { text: 'Tiered flat fee (₹9,999-₹15,999/month for up to 100 employees) plus ₹90-150 per extra employee, +18% GST', verdict: 'mid' }, labelnest: { text: '₹40,000-₹1,00,000/year flat, all modules included, no GST surprises called out', verdict: 'win' } },
