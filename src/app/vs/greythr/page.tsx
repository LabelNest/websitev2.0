...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata('/vs/greythr', {
    ...
    description: 'How NestHR compares to greytHR on pricing, modules, and campus placement — flat annual pricing by team size with PlacementOS included vs greytHR\'s tiered base-plus-per-employee model.',
  })
}
...
const DATA: VsPageData = {
  ...
  subhead: 'greytHR is a popular Indian HR and payroll platform — tiered base fee plus per-employee pricing, from ₹2,495/month (Essential, up to 50 employees) with a free tier for up to 25. NestHR is simple flat annual pricing by team size with all 7 modules included, plus PlacementOS for campus and startup hiring.',
  ...
  tableRows: [
    { feature: 'Pricing model', competitor: { text: 'Tiered base fee (from ₹2,495/month for 50 employees) plus ₹45-100/employee above that, +18% GST', verdict: 'mid' }, labelnest: { text: '₹40,000-₹1,00,000/year flat, all modules included', verdict: 'win' } },
    { feature: 'Free tier', competitor: { text: 'Free for up to 25 employees, limited features', verdict: 'win' }, labelnest: { text: 'No free tier stated — Starter begins at ₹40,000/year flat', verdict: 'no' } },
  ...
  extra: {
    ...
    body: "greytHR's assumption: companies grow into more features as they scale, paying more per employee for each added tier. NestHR's assumption: every company should get all 7 modules — including campus hiring — at every tier, priced with flat annual tiers based on team size. If you need placement-specific hiring or want to avoid tier upgrades, NestHR was built for that.",
  },
