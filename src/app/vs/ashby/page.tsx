...
const DATA: VsPageData = {
  ...
  tldrRightPoints: [
    ...
    'You want INR-native, simple flat annual pricing, not USD ATS pricing with seat tiers',
  ],
  tableRows: [
    ...
    { feature: 'Pricing', competitor: { text: '$400-$1,500+/month, elevated-seat pricing for hiring managers/admins', verdict: 'no' }, labelnest: { text: '₹40,000-₹1,00,000/year flat — includes all 7 HR modules, not just hiring', verdict: 'win' } },
