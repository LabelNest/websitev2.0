...
export async function generateMetadata(): Promise<Metadata> {
  return pageMetadata('/vs/darwinbox', {
    ...
    description: 'How NestHR compares to Darwinbox — simple, transparent flat-annual INR pricing with PlacementOS included vs Darwinbox\'s custom-quoted enterprise HRMS.',
  })
}
...
const DATA: VsPageData = {
  ...
  tldrRightPoints: [
    'You want published, transparent flat annual pricing, not a custom quote process',
  ...
  tableRows: [
    { feature: 'Pricing model', competitor: { text: 'Custom-quoted, roughly ₹60-₹450/employee/month depending on tier, 8-12% annual uplift', verdict: 'no' }, labelnest: { text: '₹40,000-₹1,00,000/year flat, published, all modules included', verdict: 'win' } },
