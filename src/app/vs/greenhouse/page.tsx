...
const DATA: VsPageData = {
  ...
  tldrRightPoints: [
    ...
    'You want INR-native, simple flat annual pricing, not USD enterprise ATS pricing',
  ...
  tableRows: [
    ...
    { feature: 'Pricing', competitor: { text: '$5,100-$70,000+/year, quote-based, median ~$12,250/year — recruiting software only', verdict: 'no' }, labelnest: { text: '₹40,000-₹1,00,000/year flat — includes all 7 HR modules, not just hiring', verdict: 'win' } },
